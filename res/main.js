...
// The native frame loop handles Pad.update() + Screen.update() + frame pacing
// for us, so the JS side only describes "what to draw this frame".
os.startFrameLoop(function () {
    ...
    cross_img.draw(5, 50);
    circle_img.draw(42, 50);
    square_img.draw(79, 50);
    triangle_img.draw(116, 50);
